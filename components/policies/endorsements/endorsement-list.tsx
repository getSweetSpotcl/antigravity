...
const TYPE_COLORS: Record<string, string> = {
    ...
    INCLUSION: "bg-blue-100 text-blue-700 border-blue-200",
    EXCLUSION: "bg-slate-100 text-slate-700 border-slate-200",
    GENERAL_MODIFICATION: "bg-amber-100 text-amber-700 border-amber-200",
}
